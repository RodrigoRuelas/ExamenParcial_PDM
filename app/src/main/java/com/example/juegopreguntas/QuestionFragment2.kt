...
class QuestionFragment2 : Fragment() {
    ...
    private fun checkAnswer(selectedIndex: Int) {
        ...
        val answerFragment = AnswerFragment1.createAnswerFragment1(isCorrect, correctAnswer)
    ...
    companion object {
        fun createQuestionFragment2(question: String, options: List<String>, correctAnswerIndex: Int): QuestionFragment2 {
            val fragment = QuestionFragment2()
            val args = Bundle()
